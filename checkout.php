...
<div class="container" style="padding-bottom: 200px">
	...
	<form action="proses/order.php" method="POST" enctype="multipart/form-data">
		...
		<div class="form-group">
			<h5>Pembayaran melalui BCA 00123456789 a.n Budiani</h5>
			<label for="exampleInputFile">Bukti Transfer Pembayaran</label>
			<input type="file" id="exampleInputFile" name="gambar">
			<p class="help-block">Ukuran gambar maksimal 2 MB.</p>
		</div>
