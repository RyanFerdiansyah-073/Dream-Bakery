...
(21, 'C0005', 'P0001', 'Cookies', 1, 25000);
...
('P0001', 'Cookies', 'cookies.jpg', '																							Kue cookies, keajaiban yang terkandung dalam satu gigitan. Lapisan renyah di luar dengan tekstur lembut di dalamnya menghasilkan harmoni sempurna. Ketika kamu menggigit kue cookies yang masih hangat, aroma vanila dan cokelat yang menggoda memenuhi hidungmu, mengundangmu untuk menikmati kelezatan yang tak terlukiskan. Nikmati kelembutan cokelat meleleh di lidahmu, menghasilkan sensasi kenikmatan yang tak tergantikan.																', 25000),
('P0002', 'Kastengel', 'kastengel1.jpg', 'Kastengel, keajaiban rasa dari negeri rempah. Keju yang melumer di mulut dan bumbu rempah yang menggoda, bersatu dalam keharmonisan sempurna. Ketika menggigit kastengel yang renyah di luar, kamu akan langsung terpikat oleh kelembutan keju di dalamnya yang meleleh, menghasilkan ledakan citarasa yang begitu memikat. Rasakan sentuhan kemewahan di setiap gigitan, yang membangkitkan kebahagiaan dan kenikmatan yang tak tergantikan.', 30000),
('P0003', 'Lidah Kucing', 'lidahkucing.jpg', 'Lidah Kucing, keindahan yang tercipta dalam setiap garis halus. Dengan kelembutan yang membelai, kue ini memberikan pengalaman yang tak terlupakan. Saat melihatnya, kamu akan terpesona oleh keanggunan rancangan dan warnanya yang memikat. Ketika kamu menggigit Lidah Kucing yang rapuh, teksturnya yang ringan dan renyah langsung meleleh di mulut, menghadirkan rasa mentega yang lembut dan manis yang langsung menyapu lidahmu. Rasakan kelezatan yang menghanyutkan, seolah-olah lidahmu menari dalam harmoni dengan setiap gigitan yang memanjakan.	', 50000),
('P0004', 'Nastar', 'nastar2.jpg', 'Nastar, keajaiban kecil yang menyimpan cita rasa kenangan. Dengan lapisan kue yang lembut dan selai nan manis, kue ini membawamu kembali ke momen-momen indah. Ketika menggigit Nastar yang sempurna, aroma harum vanila dan kelezatan selai nan lezat segera memenuhi mulutmu. Rasa manis dan asam dari selai nanas yang menyatu dengan kelembutan kue, memberikan sentuhan kenikmatan yang tak terlupakan. Nikmati kehangatan dan rasa keju yang melumer di lidahmu, mengingatkanmu pada kebahagiaan yang terkait dengan setiap gigitan kue Nastar ini.', 50000),
('P0005', 'Putri Salju', 'putrisalju.jpg', 'Kue putri salju adalah kue yang begitu lembut dan rapuh, dengan lapisan gula halus yang menari-nari di atasnya seperti salju tipis yang menutupi permukaan. Saat digigit, rasa manis dan gurih dari mentega dan vanilla segera meleleh di lidah, memberikan sensasi lembut yang luar biasa di setiap gigitannya.', 75000),
('P0006', 'Kue Sagu', 'sagu1.jpg', 'Kue Sagu, kelezatan tradisional yang menghancurkan batasan rasa. Dengan kelembutan yang menyatu dengan kegurihan, kue ini mengajakmu pada perjalanan rasa yang tak terlupakan. Ketika menggigit Kue Sagu yang lembut dan berbutir halus, sensasi kenyalnya segera memanjakan lidahmu. Rasakan sentuhan manis dari gula dan keharuman santan yang memikat, memberikan pengalaman yang memanjakan indera. Setiap gigitan menghadirkan tekstur yang lembut namun renyah di mulutmu, membawa kepuasan yang tak tertandingi. Nikmati keajaiban rasa yang terkandung dalam setiap suap Kue Sagu ini, membangkitkan nostalgia akan cita rasa yang klasik dan autentik.', 50000);
